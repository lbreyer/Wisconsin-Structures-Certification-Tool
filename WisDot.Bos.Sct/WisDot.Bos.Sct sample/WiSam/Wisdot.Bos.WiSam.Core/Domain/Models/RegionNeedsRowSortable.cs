...
namespace Wisdot.Bos.WiSam.Core.Domain.Models
{
    class RegionNeedsRowSortable
    {
        ...
        //public double PrimaryCostEffectiveness { get; set; }
        ...
        public double StructuralCapacityFactor { get; set; }
        public double ConditionFactor { get; set; }
        public double CostEffectivenessFactor { get; set; }
